...
train_data = pd.read_csv('/Users/aishwaryapirankar/Desktop/Bootcamp Projects/Yield Prediction/Data/train_data.csv', nrows=300)
...
RF_reg = RandomForestRegressor(bootstrap=True, criterion='squared_error', max_depth=None,
...
submission.to_csv('/Users/aishwaryapirankar/Desktop/Bootcamp Projects/Yield Prediction/predict_submission.csv', index = None)
